...
```
python3 F:\IPA_DOWNLOAD_TOOL\ipatool-py-master\ipatool-py-master\main.py lookup -b com.netflix.Netflix -c JP download -s http://127.0.0.1:9000 --appVerId 838033742
```
